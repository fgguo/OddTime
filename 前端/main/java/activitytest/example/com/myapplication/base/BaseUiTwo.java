...
public class BaseUiTwo extends Fragment {

    //	protected BaseApp app;
    protected BaseHandlerTwo handler;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // async task handler
        this.handler = new BaseHandlerTwo(this);
        // init task pool
...
//		this.app = (BaseApp) this.getApplicationContext();
    ...
    public BaseHandlerTwo getHandler () {
        return this.handler;
    }

    public void setHandler (BaseHandlerTwo handler) {
